...
\ifpdf
\pdfinfo{
   /Author (Oliver James Henry Feighan)
   /Title (Efficient Response Methods for Aggregate Chlorophyll Systems)
...
\usepackage[version=4]{mhchem}			% chemistry equations
%
...
%
\newcommand{\dscf}[0]{$\Delta$-SCF }
\newcommand{\dxtb}[0]{$\Delta$-xTB }
\newcommand{\code}[1]{{\fontfamily{qcr}\selectfont{#1}}}
\newcommand{\Qy}{$Q_y$ }
\newcommand{\functional}[3]{#1_{#2} \left[ #3 \right]}
...
% subdirectories.
\mainmatter
\import{chapters/}{outline.tex}
\clearemptydoublepage
%
\import{chapters/1_introduction/}{introduction.tex}
\clearemptydoublepage
%
\import{chapters/2_background_theory/}{background_theory.tex}
\clearemptydoublepage
%
\import{chapters/3_dscf/}{dscf.tex}
\clearemptydoublepage
%
\import{chapters/4_chl_xtb/}{chl_xtb.tex}
\clearemptydoublepage
%
\import{chapters/5_excitons/}{excitons.tex}
\clearemptydoublepage
%
\import{chapters/6_spectral_density/}{spectral_density.tex}
\clearemptydoublepage
%
 \import{chapters/7_conclusions/}{conclusions.tex}
\clearemptydoublepage
%
%
%
...
\bibliography{/Users/of15641/Documents/library.bib}
\clearemptydoublepage
%
\end{document}