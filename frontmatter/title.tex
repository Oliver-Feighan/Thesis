...
{\HUGE Efficient Protocols for Excited States of Large Biochromophores}\\[4mm]
\rule[0.5ex]{\linewidth}{1pt}\vspace*{-\baselineskip}\vspace{3.2pt}
\rule[0.5ex]{\linewidth}{2pt}\\
\vspace{6.5mm}
{\large By}\\
\vspace{6.5mm}
{\large\textsc{Oliver James Henry Feighan}}\\
\vspace{11mm}
...
\end{minipage}\\
\vspace{9mm}
{\large\textsc{January, 2023}}
\vspace{12mm}
\end{center}
\begin{flushright}
{\small Word count: 55,491}
\end{flushright}
\end{adjustwidth*}
\end{SingleSpace}
\end{titlingpage}