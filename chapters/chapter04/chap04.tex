...
\begin{figure}
    \centering
    \includegraphics[origin=c, angle=90, scale=0.4]{../../Year_2/DimerModel/CAMB3LYP_exciton_v_tddft_coupling_and_distance.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4, origin=c, angle=90]{../../Year_2/DimerModel/Scans/camb3lyp_rotation_along_Qz.png}
    \caption{caption}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[scale=0.4, origin=c, angle=90]{../../Year_2/DimerModel/Scans/camb3lyp_rotation_along_Qx.png}
    \caption{caption}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[scale=0.4, origin=c, angle=90]{../../Year_2/DimerModel/Scans/camb3lyp_rotation_along_Qy.png}
    \caption{caption}
\end{figure}
...
\begin{figure}
    \includegraphics[scale=0.4, angle=90, origin=c]{../../Year_2/DimerModel/chl_xtb_pbe0_CAMB3LYP_tddft_coupling.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4, angle=90, origin=c]{../../Year_2/DimerModel/Scans/rotation_along_Qz.png}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[scale=0.4, angle=90, origin=c]{../../Year_2/DimerModel/Scans/rotation_along_Qy.png}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[scale=0.4, angle=90, origin=c]{../../Year_2/DimerModel/Scans/rotation_along_Qx.png}
\end{figure}
...
were prepared using \code{Packmol} into 100 \AA{} boxes, with forcefield parameters taken
