...
Detailed computational study of these structures has been possible since the high
...
In 2016 H\"{a}se \emph{et al.} reported on a multi-perceptron (neural network (NN))
