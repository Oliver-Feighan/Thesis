...
\begin{figure}
    \centering
    \includegraphics[]{../../Year_3/SpectralDensity/images/peaks_ether.png}i
...
\begin{figure}
    \centering
    \includegraphics[angle=90, origin=c, scale=0.85]{../../Year_3/SpectralDensity/images/specdens_all.png}
