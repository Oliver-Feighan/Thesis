...
\begin{figure}
    %\includegraphics[scale=0.1]{../../Year_2/chlorophyll_parameterization/cube_files/HOMO.png}
    \caption{caption}
    \label{fig:HOMO}
\end{figure}

\begin{figure}
%    \includegraphics{../../Year_2/chlorophyll_parameterization/cube_files/LUMO.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6, angle=90, origin=c]{../../Year_2/AbsorptionSpectra/cla_diethyl_ether_spectra.png}
